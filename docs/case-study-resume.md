...
- **Custom scoring engine** with multi-swell decomposition — pure deterministic 0–100 score per spot per hour. 95 Vitest tests. Multi-train spectral peak-finding over NDBC 47-bin data. Per-spot `shadowFactor` calibration calibrated against coastal geometry (Cowells 0.30 deep shadow, Steamer Lane outside 0.90 fully exposed).
...
**~8,630 lines of TypeScript across 52 source files · 220 commits · 64 surf spots modeled · 7-day hourly forecast horizon · 95 Vitest tests across 10 files · 8 live public data sources · 5 county water-quality endpoints · 4 third-party JS dependencies · $0 hosting · $0 data**
