...
const INSIGHTS: Record<string, string> = {
  ...
  'shark-pit': 'Boat-access-only left at the mouth of Tomales Bay. Breaks on W-NW groundswell with SE winds, incoming tide only. Confirmed great white breeding ground — heaviest hazard exposure on the list. Expert only.',
...
const HAZARDS: Record<string, string[]> = {
  ...
  'shark-pit': ['White sharks', 'Strong currents', 'Boat access'],
