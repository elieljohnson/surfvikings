...
const INSIGHTS: Record<string, string> = {
  ...
  'ocean-beach': 'Three miles of shifting beachbreak between Sloat and the north end. Open to swell from N, W, and S. Tide swing through the Golden Gate dislocates sandbars hour to hour. Paddle-outs are survival exercises on solid days.',
