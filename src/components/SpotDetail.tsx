...
const INSIGHTS: Record<string, string> = {
  ...
  'point-reyes-north': 'North access of the 11-mile Great Beach (Pt Reyes Station road). Consistent but deadly. Great white territory. Beach shifts constantly — never surf alone here.',
...
const HAZARDS: Record<string, string[]> = {
  ...
  'point-reyes-north': ['Extreme rips', 'Sharks', 'Shifty break'],
