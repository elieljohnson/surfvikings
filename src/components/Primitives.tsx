...
const WaveIcon = (
  <svg width="24" height="16" viewBox="0 0 24 16" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round">
    <path d="M2 13 C 6 13, 12 3, 15 2.5 C 20 2.5, 23 8, 21.5 12 C 20.5 13.2, 18 13.2, 17.2 10.8 C 16.5 8.8, 18.5 7.5, 20 8.5"/>
  </svg>
);
...
const BarsIcon = (
  <svg width="22" height="16" viewBox="0 0 24 16" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinejoin="round">
...
// Gear — Lucide-style settings glyph, matching the wave/bars stroke weight.
const GearIcon = (
