...
export const SPOTS: Spot[] = [
  ...
  { id: 'secrets',       region: 'sonoma',   regionLabel: 'Sonoma Coast', name: 'Secrets',             subtitle: 'Horseshoe Cove · Salt Point', difficulty: 7,  type: 'Reef · Left',          bottom: 'Rock reef',     optimalSwell: 270, optimalSize: [4,8], optimalPeriod: [14,18], offshore: 180, optimalTide: 'low',    lat: 38.5651, lng: -123.3294, driveMin: 112 },
  ...
  { id: 'rockaway',      region: 'sm-north', regionLabel: 'Pacifica',     name: 'Rockaway',            subtitle: 'Pacifica',                     difficulty: 5,  type: 'Beach + reef',         bottom: 'Sand + rock',   optimalSwell: 300, optimalSize: [3,7], optimalPeriod: [12,16], offshore: 135, optimalTide: 'low',    lat: 37.6112, lng: -122.4956, driveMin: 42 },
  ...
  { id: 'princeton',     region: 'sm-north', regionLabel: 'Half Moon Bay',name: 'Princeton Jetty',     subtitle: 'Pillar Point Harbor',          difficulty: 2,  type: 'Jetty · Wedge',        bottom: 'Sand',          optimalSwell: 225, optimalSize: [2,5], optimalPeriod: [10,14], offshore: 70,  optimalTide: 'high',   lat: 37.4944, lng: -122.4836, driveMin: 58 },
  { id: 'mavericks',     region: 'sm-north', regionLabel: 'Half Moon Bay',name: 'Mavericks',           subtitle: 'Big wave reef',                difficulty: 10, type: 'Reef · XXL',           bottom: 'Ledge reef',    optimalSwell: 310, optimalSize: [15,60],optimalPeriod:[18,22], offshore: 70,  optimalTide: 'high',   lat: 37.4936, lng: -122.4960, driveMin: 58, watchOnly: true },
  { id: 'hmb-jetty',     region: 'sm-north', regionLabel: 'Half Moon Bay',name: 'HMB Jetty',           subtitle: 'Jetty Beach',                  difficulty: 4,  type: 'Beach + jetty',        bottom: 'Sand',          optimalSwell: 285, optimalSize: [3,6], optimalPeriod: [12,16], offshore: 70,  optimalTide: 'high',   lat: 37.4694, lng: -122.4497, driveMin: 62 },
...
export function scoreToRating(score: number, watchOnly?: boolean): Rating {
  if (watchOnly) {
    ...
    if (score >= 35) return { label: 'WATCH', tone: 'watch', color: '#E6B800' };
    return { label: 'FLAT', tone: 'flat', color: '#6b7280' };
  }
  if (score >= 75) return { label: 'EPIC', tone: 'epic', color: '#22c55e' };
  if (score >= 55) return { label: 'GOOD', tone: 'good', color: '#eab308' };
  if (score >= 35) return { label: 'FAIR', tone: 'fair', color: '#f97316' };
