...
export const SPOTS: Spot[] = [
  ...
  { id: 'fort-point',    region: 'sf', regionLabel: 'San Francisco',   name: 'Fort Point',          subtitle: 'Under the Golden Gate',        difficulty: 7,  type: 'Reef · Left',          bottom: 'Boulders',      optimalSwell: 290, optimalSize: [4,12],optimalPeriod: [12,18], offshore: 180, optimalTide: 'low',    lat: 37.8108, lng: -122.4770, driveMin: 24,
    shadowFactor: 0.25, sandMobility: 0.0 },
  { id: 'deadmans',      region: 'sf', regionLabel: 'San Francisco',   name: 'Deadmans',            subtitle: 'Lands End · Sutro Baths reef', difficulty: 8,  type: 'Reef · Left',          bottom: 'Uneven reef',   optimalSwell: 315, optimalSize: [6,12],optimalPeriod: [14,18], offshore: 135, optimalTide: 'low',    lat: 37.7800, lng: -122.5135, driveMin: 30,
    shadowFactor: 0.7, sandMobility: 0.0 },
  { id: 'kellys-cove',   region: 'sf', regionLabel: 'San Francisco',   name: "Kelly's Cove",        subtitle: 'OB north end · Cliff House shelter', difficulty: 4, type: 'Cove · Beach',         bottom: 'Sand',          optimalSwell: 225, optimalSize: [2,8], optimalPeriod: [10,14], offshore: 90,  optimalTide: 'mid',    lat: 37.7780, lng: -122.5135, driveMin: 30,
    shadowFactor: 0.6, sandMobility: 0.7 },
  { id: 'ocean-beach-north', region: 'sf', regionLabel: 'San Francisco', name: 'Ocean Beach (N)', subtitle: 'North end · Lawton to Lincoln',  difficulty: 6, type: 'Beach · Powerful',     bottom: 'Sand',          optimalSwell: 290, optimalSize: [3,10],optimalPeriod: [12,18], offshore: 90,  optimalTide: 'mid',    lat: 37.7700, lng: -122.5125, driveMin: 31,
    shadowFactor: 0.95, sandMobility: 0.95 },
  { id: 'ocean-beach',   region: 'sf', regionLabel: 'San Francisco',   name: 'Ocean Beach',         subtitle: 'Central · Mid avenues',        difficulty: 7,  type: 'Beach · Powerful',     bottom: 'Sand',          optimalSwell: 290, optimalSize: [4,15],optimalPeriod: [14,20], offshore: 100, optimalTide: 'mid',    lat: 37.7604, lng: -122.5107, driveMin: 32,
    shadowFactor: 0.95, sandMobility: 0.95 },
  { id: 'ocean-beach-south', region: 'sf', regionLabel: 'San Francisco', name: 'Ocean Beach (S)', subtitle: 'Sloat · VFW to Sloat Blvd',     difficulty: 7,  type: 'Beach · Powerful',     bottom: 'Sand',          optimalSwell: 290, optimalSize: [3,12],optimalPeriod: [12,18], offshore: 80,  optimalTide: 'mid',    lat: 37.7400, lng: -122.5083, driveMin: 33,
    shadowFactor: 0.95, sandMobility: 0.95 },
