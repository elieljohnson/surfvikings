...
export const SPOTS: Spot[] = [
  ...
  { id: '26th-ave',      region: 'sc',       regionLabel: 'Santa Cruz',   name: '26th Avenue',         subtitle: 'Beach + reef peaks · Springtime windswell', difficulty: 5,  type: 'Beach + reef',         bottom: 'Sand + rock',   optimalSwell: 270, optimalSize: [2,6], optimalPeriod: [10,16], offshore: 45,  optimalTide: 'mid',    lat: 36.9610, lng: -121.9840, driveMin: 132 },
