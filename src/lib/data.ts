...
export const SPOTS: Spot[] = [
  ...
  // Region 6 — Santa Cruz
  { id: 'laguna-creek',  region: 'sc',       regionLabel: 'Santa Cruz',   name: 'Laguna Creek',        subtitle: 'Whomping beachbreak · Small-day windswell', difficulty: 4,  type: 'Beach',                bottom: 'Sand',          optimalSwell: 270, optimalSize: [2,6], optimalPeriod: [10,14], offshore: 45,  optimalTide: 'low',    lat: 36.9850, lng: -122.1560, driveMin: 117 },
  { id: 'four-mile',     region: 'sc',       regionLabel: 'Santa Cruz',   name: 'Four Mile',           subtitle: 'Right pointbreak · Fast and hollow', difficulty: 6,  type: 'Point · Right',        bottom: 'Rock reef',     optimalSwell: 295, optimalSize: [3,12],optimalPeriod: [12,18], offshore: 45,  optimalTide: 'mid',    lat: 36.9597, lng: -122.1775, driveMin: 120 },
  { id: 'three-mile',    region: 'sc',       regionLabel: 'Santa Cruz',   name: 'Three Mile',          subtitle: 'Right point/reef · Pressure valve for Four Mile', difficulty: 5,  type: 'Point · Right',        bottom: 'Rock reef',     optimalSwell: 270, optimalSize: [3,9], optimalPeriod: [14,18], offshore: 45,  optimalTide: 'mid',    lat: 36.9580, lng: -122.1620, driveMin: 122 },
  { id: 'natural-bridges', region: 'sc',     regionLabel: 'Santa Cruz',   name: 'Natural Bridges',     subtitle: 'Right reef · The Sidewalk · Sharp shallow ledge', difficulty: 7,  type: 'Point · Right',        bottom: 'Rock reef',     optimalSwell: 295, optimalSize: [3,10],optimalPeriod: [12,18], offshore: 45,  optimalTide: 'low',    lat: 36.9515, lng: -122.0580, driveMin: 126 },
  { id: 'mitchells-cove', region: 'sc',      regionLabel: 'Santa Cruz',   name: "Mitchell's Cove",     subtitle: 'Right point · Fickle but world-class on its day', difficulty: 6,  type: 'Point · Right',        bottom: 'Rock reef + sand', optimalSwell: 295, optimalSize: [4,12],optimalPeriod: [12,18], offshore: 45,  optimalTide: 'low',    lat: 36.9540, lng: -122.0490, driveMin: 127 },
  { id: 'stockton-ave',  region: 'sc',       regionLabel: 'Santa Cruz',   name: 'Stockton Avenue',     subtitle: 'Weasel Reef · Tiny right barrel · Heavy localism', difficulty: 7,  type: 'Reef · Right',         bottom: 'Rock reef',     optimalSwell: 200, optimalSize: [2,5], optimalPeriod: [12,18], offshore: 45,  optimalTide: 'low',    lat: 36.9510, lng: -122.0450, driveMin: 127 },
  { id: 'steamer-point', region: 'sc',       regionLabel: 'Santa Cruz',   name: 'The Point',           subtitle: 'Steamer Lane outside · Hyper-competitive', difficulty: 7,  type: 'Point · Right',        bottom: 'Rock + kelp',   optimalSwell: 200, optimalSize: [3,15],optimalPeriod: [14,20], offshore: 315, optimalTide: 'low',    lat: 36.9504, lng: -122.0255, driveMin: 128 },
  { id: 'steamer-middle', region: 'sc',      regionLabel: 'Santa Cruz',   name: 'Middle Peak',         subtitle: 'Steamer Lane · Heavy elevator drops · 3 reefs', difficulty: 6,  type: 'Reef · L/R',           bottom: 'Rock + kelp',   optimalSwell: 315, optimalSize: [2,18],optimalPeriod: [12,20], offshore: 315, optimalTide: 'mid',    lat: 36.9510, lng: -122.0240, driveMin: 128 },
  { id: 'steamer-indicators', region: 'sc', regionLabel: 'Santa Cruz',   name: 'Indicators',          subtitle: 'Steamer Lane · Classic long right · Magazine peak', difficulty: 5,  type: 'Point · Right',        bottom: 'Rock + kelp',   optimalSwell: 295, optimalSize: [2,12],optimalPeriod: [12,18], offshore: 315, optimalTide: 'low',    lat: 36.9513, lng: -122.0230, driveMin: 128 },
  { id: 'steamer-slot',  region: 'sc',       regionLabel: 'Santa Cruz',   name: 'The Slot',            subtitle: 'Steamer Lane inside · Tube spot under the cliff', difficulty: 5,  type: 'Point · Right',        bottom: 'Rock + kelp',   optimalSwell: 270, optimalSize: [2,12],optimalPeriod: [12,18], offshore: 315, optimalTide: 'low',    lat: 36.9516, lng: -122.0220, driveMin: 128 },
  { id: 'cowell',        region: 'sc',       regionLabel: 'Santa Cruz',   name: 'Cowells',             subtitle: 'Long mellow point · Learner-friendly', difficulty: 1,  type: 'Point · Right',        bottom: 'Sand',          optimalSwell: 270, optimalSize: [2,5], optimalPeriod: [10,14], offshore: 315, optimalTide: 'rising', lat: 36.9543, lng: -122.0201, driveMin: 128 },
  { id: 'rivermouth',    region: 'sc',       regionLabel: 'Santa Cruz',   name: 'The Rivermouth',      subtitle: 'San Lorenzo · Fickle hollow sandbar · Runoff-sensitive', difficulty: 5,  type: 'Rivermouth · L/R',     bottom: 'Sand',          optimalSwell: 295, optimalSize: [2,6], optimalPeriod: [12,16], offshore: 0,   optimalTide: 'low',    lat: 36.9610, lng: -122.0120, driveMin: 130,
    specialRules: [{ kind: 'falling-tide-rip', below: 2, penalty: -15 }] },
  { id: 'sc-harbor',     region: 'sc',       regionLabel: 'Santa Cruz',   name: 'Santa Cruz Harbor',   subtitle: 'West-jetty suckout barrel · Illegal · Experts only', difficulty: 9,  type: 'Jetty · Right',        bottom: 'Sand',          optimalSwell: 295, optimalSize: [3,10],optimalPeriod: [12,18], offshore: 45,  optimalTide: 'low',    lat: 36.9620, lng: -122.0000, driveMin: 131 },
  { id: '26th-ave',      region: 'sc',       regionLabel: 'Santa Cruz',   name: '26th Avenue',         subtitle: 'Eastside beachbreak · Holds small, closes out big', difficulty: 5,  type: 'Beach + reef',         bottom: 'Sand + rock',   optimalSwell: 270, optimalSize: [2,6], optimalPeriod: [10,16], offshore: 45,  optimalTide: 'rising', lat: 36.9610, lng: -121.9840, driveMin: 132 },
  { id: 'pleasure-sewer', region: 'sc',      regionLabel: 'Santa Cruz',   name: 'Sewer Peak',          subtitle: 'Top of the point · Top-to-bottom barrel', difficulty: 6,  type: 'Point · Right',        bottom: 'Rock + kelp',   optimalSwell: 235, optimalSize: [2,12],optimalPeriod: [12,18], offshore: 0,   optimalTide: 'low',    lat: 36.9605, lng: -121.9695, driveMin: 132 },
  { id: 'pleasure-first', region: 'sc',      regionLabel: 'Santa Cruz',   name: 'First Peak',          subtitle: 'Utility right · Works on most swells and tides', difficulty: 5,  type: 'Point · Right',        bottom: 'Rock + kelp',   optimalSwell: 270, optimalSize: [2,12],optimalPeriod: [12,18], offshore: 0,   optimalTide: 'mid',    lat: 36.9595, lng: -121.9678, driveMin: 132 },
  { id: 'pleasure-second',region: 'sc',      regionLabel: 'Santa Cruz',   name: 'Second Peak',         subtitle: 'Lined-up wall · Grommet pack hangout', difficulty: 5,  type: 'Point · Right',        bottom: 'Rock + kelp',   optimalSwell: 270, optimalSize: [2,12],optimalPeriod: [12,18], offshore: 0,   optimalTide: 'low',    lat: 36.9585, lng: -121.9665, driveMin: 132 },
  { id: 'pleasure-insides',region: 'sc',     regionLabel: 'Santa Cruz',   name: 'Insides',             subtitle: 'aka Middle Peak · Longboarder cruise', difficulty: 3,  type: 'Point · Right',        bottom: 'Rock + kelp',   optimalSwell: 270, optimalSize: [2,8], optimalPeriod: [12,18], offshore: 0,   optimalTide: 'low',    lat: 36.9580, lng: -121.9658, driveMin: 132 },
  { id: 'jacks',         region: 'sc',       regionLabel: 'Santa Cruz',   name: "Jack's",              subtitle: '38th Ave · World-class on big winter or S swells', difficulty: 4,  type: 'Point · Right',        bottom: 'Rock + kelp',   optimalSwell: 245, optimalSize: [3,12],optimalPeriod: [12,18], offshore: 0,   optimalTide: 'low',    lat: 36.9575, lng: -121.9648, driveMin: 133 },
  { id: 'capitola',      region: 'sc',       regionLabel: 'Santa Cruz',   name: 'Capitola',            subtitle: 'Soft right reef/point · Beginner/longboard staple', difficulty: 3,  type: 'Point · Right',        bottom: 'Sand + rock',   optimalSwell: 200, optimalSize: [2,7], optimalPeriod: [10,14], offshore: 0,   optimalTide: 'mid',    lat: 36.9736, lng: -121.9533, driveMin: 136 },
  { id: 'capitola-rivermouth', region: 'sc', regionLabel: 'Santa Cruz',   name: 'Capitola Rivermouth', subtitle: 'Soquel Creek mouth · Punchy rights when it fires', difficulty: 3,  type: 'Rivermouth · Right',   bottom: 'Sand',          optimalSwell: 295, optimalSize: [2,6], optimalPeriod: [12,16], offshore: 45,  optimalTide: 'low',    lat: 36.9725, lng: -121.9530, driveMin: 137,
    specialRules: [{ kind: 'falling-tide-rip', below: 2, penalty: -15 }] },
  { id: 'the-hook',      region: 'sc',       regionLabel: 'Santa Cruz',   name: 'The Hook',            subtitle: 'Bay-tucked right · Best on macking S swells', difficulty: 5,  type: 'Reef · Right',         bottom: 'Rock + kelp',   optimalSwell: 245, optimalSize: [3,10],optimalPeriod: [12,16], offshore: 0,   optimalTide: 'rising', lat: 36.9582, lng: -121.9627, driveMin: 134 },
  { id: 'privates',      region: 'sc',       regionLabel: 'Santa Cruz',   name: 'Privates',            subtitle: 'Tucked rock/sand rights · Needs big swell', difficulty: 4,  type: 'Reef + beach',         bottom: 'Rock + sand',   optimalSwell: 350, optimalSize: [3,8], optimalPeriod: [12,18], offshore: 0,   optimalTide: 'low',    lat: 36.9665, lng: -121.9605, driveMin: 135 },
