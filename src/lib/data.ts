...
export const SPOTS: Spot[] = [
  ...
  { id: 'sharp-park',    region: 'sm-north', regionLabel: 'Pacifica',     name: 'Sharp Park',          subtitle: 'Pier sandbar · Pacifica',      difficulty: 6,  type: 'Beach · Pier/groyne',  bottom: 'Boulders + sand',optimalSwell: 270, optimalSize: [3,12],optimalPeriod: [12,18], offshore: 90,  optimalTide: 'low',    lat: 37.6325, lng: -122.4900, driveMin: 38,
    shadowFactor: 0.9, sandMobility: 0.85 },
